...
/**
 * A singleton for making AJAX requests to Parse.  Automatically adds the required
 * headers, and constructs the full URL.
 *
 * @author Hayden Gomes
 */
Ext.define("Ext.ux.parse.ParseAjax", {
    ...
    /**
     * Specialized version of setupHeaders which adds the required Parse headers.
    ...
    /**
     * Specialized version of setupUrl to prepend the Parse URL root
